...
<body>
	...
	<c:choose>
		...
		<c:otherwise>
			<h2>[${sessionScope.m.memberName }]님 방가방가용</h2>
			<h3><a href="/allMemberChat.do">전체채팅</a></h3>
			<h3><a href="/dmMain.do"><img src="resources/dm/mark_email_unread.png"></a></h3>
